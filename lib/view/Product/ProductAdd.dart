...
import 'package:admin/Comom_widget/Dropdown.dart';
import 'package:admin/Comom_widget/ImagepickerView.dart';
import 'package:admin/Comom_widget/lineInput.dart';
import 'package:admin/Comom_widget/popout.dart';
...
class _ProductaddState extends State<Productadd> {
  ...
  final TextEditingController Nutriongram = TextEditingController();
  final TextEditingController nutrivaluecontroller = TextEditingController();
  final TextEditingController nutrinamecontroller = TextEditingController();
              ...
              children: [
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(context,
                            PopoutLayout(child: Imagepickerview(
                              didSelect: (newimage) {
                                productservice.Images.value.add(File(newimage).path);
                ...
                Obx(() {
                  return RoundButton(
                    ...
                    onpresed: () async {
                      if (_formkey.currentState?.validate() ?? false) {
                        final result = await productservice.CreateProduct(
                            ...
                            unitvalue.text,
                            price.text,
                            productservice.nutritionList.value
                                .map((item) =>
                            ({
                    ...
                    bgcolor: productservice.isloading.value == false
                        ? Tcolor.primary
                        : Tcolor.disablecolor,
                  );
                }),
