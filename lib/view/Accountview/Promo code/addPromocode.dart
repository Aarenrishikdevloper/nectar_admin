...
class _AddpromocodeState extends State<Addpromocode> {
  ...
  final TextEditingController controllerOffer = TextEditingController();
  final TextEditingController controllerMinprice = TextEditingController();
  final TextEditingController controllerMaxPrice = TextEditingController();
                      ...
                      children: [
                        ...
                        Obx(() {
                          return RoundButton(Title: pvm.isloading.value == false
                              ? "Add"
                              : "...Adding", onpresed: ()async {
                           final res = await  pvm.addpromo(
                                controllerPromo.text, controllerTitle.text,
